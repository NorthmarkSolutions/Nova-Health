...
import { StaffMasterSection } from './organization/StaffMasterSection';
...
export const OrganizationSetup: React.FC = () => {
  const [activeSubTab, setActiveSubTab] = useState<
    'profile' | 'infrastructure' | 'departments' | 'staff' | 'onboarding'
  >('profile');

  return (
    <div>
      {/* 5-Part Hospital Onboarding Master Sub-Navigation */}
      <div className="subtab-bar" style={{ marginBottom: '1.5rem', overflowX: 'auto', paddingBottom: '0.25rem' }}>
        ...
        >
          <Sparkles size={16} /> 5. Onboarding Progress (0% to 100%)
        </button>
      </div>
